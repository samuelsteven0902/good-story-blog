...
function ContactUs() {
  return (
    <div>
        ...
        <section class="bg-[#1E1E1E] dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-white dark:text-white">Contact Us</h2>
                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">If there are criticisms and suggestions, thank you for giving us feedback. Let us know.</p>
                <form action="#" class="space-y-8">
                    ...
                    <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-slate-700 sm:w-fit hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800">Send message</button>
                </form>
            </div>
        </section>
